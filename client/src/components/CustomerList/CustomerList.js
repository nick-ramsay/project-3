        ...
        <div className="col-md-12">
            <div class="card mb-2">
                ...
                <div className="card-body">
                    ...
                    <button className="btn btn-primary m-1 float-right" id="editCustomerBtn" data-toggle="modal" data-target="#editCustomerModal" data-customer-state-index={props.customerStateIndex} onClick={props.editCustomer}><img src={require("../../images/edit-icon.png")} alt="Edit Customer" /></button>

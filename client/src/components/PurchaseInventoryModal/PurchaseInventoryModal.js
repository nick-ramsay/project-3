            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    ...
                    <div className="modal-footer">
                        <button type="button" className="btn btn-sm" id="purchaseInventorySubmitBtn" name="purchaseInventorySubmitBtn" onClick={props.handlePurchaseInventorySubmit}>Purchase</button>

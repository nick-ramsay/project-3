        ...
        <div className="col-md-12">
            <div class="card mb-2">
                ...
                <div className="card-body">
                    ...
                    <button className="btn btn-primary m-1 float-right" id="editInventoryBtn" data-toggle="modal" data-target="#editProjectModal" data-project-state-index={props.projectStateIndex} onClick={props.editProject}><img src={require("../../images/edit-icon.png")} alt="Edit Project" /></button>
                    <button className="btn btn-danger m-1 float-right deleteInventoryBtn"><img src={require("../../images/delete-icon.png")} alt="Delete Project" /></button>

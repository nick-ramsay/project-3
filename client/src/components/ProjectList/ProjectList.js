        ...
        <div className="col-md-12 pb-2">
            <div class="card mb-2">
                ...
                <div className="card-body">
                    <button className="btn btn-sm m-1 projectDetails" type="button" data-toggle="collapse" id={props.projectID && "project" + props.projectID} data-target={props.projectID && "#projectDetails" + props.projectID}>Details</button>
                    <button className="btn btn-sm m-1 float-right" id="editInventoryBtn" data-toggle="modal" data-target="#editProjectModal" data-project-state-index={props.projectStateIndex} onClick={props.editProject}>Edit</button>

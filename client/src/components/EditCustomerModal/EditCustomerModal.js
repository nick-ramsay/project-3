                            ...
                            <div className="col-md-12">
                                <form>
                                    ...
                                    <div className="form-row">
                                        ...
                                        <div className="form-group col-md-12">
                                            <label for="editCustomerCancelled">Cancellation Date</label>
                                            <input type="date" className="form-control" id="editCustomerCancelled" value={props.customerDetails.cancelled && props.customerDetails.cancelled} name="editCustomerCancelled" onChange={props.handleFormUpdate}/>
                                        </div>
                                    </div>
                                </form>
                            </div>

        ...
        <div className="col-md-12">
            <div class="card mb-2">
                ...
                <div className="card-body">
                    ...
                    <button className="btn btn-sm m-1 float-left btn-sm" id="issueRefundBtn" data-toggle="modal" data-target="#issueRefundModal" data-bill-state-index={props.billStateIndex} data-refund-bill-id={props.billID} name="issueRefundModal" onClick={props.handleIssueRefund}><strong>Issue Refund</strong></button>
                    <button className="btn btn-sm m-1 float-left btn-sm" id="paymentReceivedBtn" data-toggle="modal" data-target="#paymentReceivedModal" data-bill-state-index={props.billStateIndex} data-payment-bill-id={props.billID} name="purchasbillBtn" onClick={props.handlePaymentReceived}><strong>Post Payment</strong></button>
                    <button className="btn btn-sm m-1 float-right btn-sm" id="billPDFBtn" data-bill-state-index={props.billStateIndex}>
                        <PDFDownloadLink

        ...
        <div className="col-md-12">
            <div class="card mb-2">
                ...
                <div className="card-body">
                    ...
                    {!props.cancelled && <button className="btn btn-danger m-1 float-right btn-sm" id="deleteBillBtn" data-cancel-bill-id={props.billID} name="deleteBillBtn" onClick={props.cancelBill}><img src={require("../../images/delete-icon.png")} alt="End Date Bill" /></button>}
